...
public class htmlDecorator {
    ...
    public static String gameModeDecorate(String message) {
        ...
        String html = "<!DOCTYPE html>"
                    ...
                    + message
                    + "</p><form action=\"http://localhost:5000/game-mode\" method=\"post\">"
                    + "<input name=\"gamemode\" type=\"radio\" value=\"hh\">Human vs Human</input>"
    ...
    public static String nameDecorate(String message, String playerPath) {
        String alertMessage = showAlert();
        String html = "<!DOCTYPE html>"
                    + "<html><head></head><body><p>"
                    + message
                    + "</p><form action=\"http://localhost:5000/\""
                    + playerPath
